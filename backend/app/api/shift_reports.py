...
async def create_shift_report(
        ...
        yandex_pay_qr: int = Form(default=0, description="QR код от Яндекс.Пэй", example=800, ge=0),
        qr_code: int = Form(default=0, description="QR код (не работает терминал, QR с телеграмм)", example=1500, ge=0),
    ...
    try:
        ...
        for report in reports:
            reports_list.append({
                ...
                "yandex_pay_qr": float(report.yandex_pay_qr) if report.yandex_pay_qr else 0,
